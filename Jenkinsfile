pipeline {
    ...
    parameters {
         string(name: 'tomcat_dev', defaultValue: '52.215.36.71', description: 'Staging Server')
         string(name: 'tomcat_prod', defaultValue: '52.213.188.239', description: 'Production Server')
    }
